...
/**
 * Kolom yang boleh di-sort (HARUS sesuai DB)
 */
...
/**
 * Search (🔥 jangan pakai :q berulang, bikin :q1 :q2 :q3)
 */
$where  = "";
$params = [];
  ...
  if (!$rows) {
    ...
    foreach ($rows as $u) {
      ...
      echo "<tr>
        ...
        <td class='center'>".number_format($daya,0,',','.')." VA</td>
        <td class='center'>Rp ".number_format($total,0,',','.')."/bulan</td>
